...
[outOrdenada,inOrdenada] = estructuraRegresoresVelocidad(lowData,mediumData,highData,lowSpeed,mediumSpeed,highSpeed,nRegresores,0);
...
title('Comparación entre salida estimada y real. 1 Paso.')
...
title('Diferencia entre salida estimada y real. 1 Paso.')
xlabel('Numero de muestra')
